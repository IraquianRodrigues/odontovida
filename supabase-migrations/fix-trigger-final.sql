-- ============================================
-- CORREÇÃO FINAL DO TRIGGER DE NOTIFICAÇÕES
-- ============================================
-- Este script recria completamente a função e o trigger
-- para garantir que as notificações sejam criadas corretamente
-- ============================================
...
-- PASSO 2: Criar função atualizada com formatação bonita
...
-- IMPORTANTE: Ajuste a data para não conflitar com agendamentos existentes
...
-- Se o appointment_id não for NULL, o trigger está funcionando! 🎉
